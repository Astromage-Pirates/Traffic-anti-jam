...
modelsPath="ret/Traffic-anti-jam/API/Model/"
apiPath="../../src/Traffic-anti-jam/Assets/Traffic-anti-jam/Scripts/API/Model"

testsPathSrc="ret/API/Models/Test/"
testsPathDst="../../src/Traffic-anti-jam/Assets/Traffic-anti-jam/Scripts/Editor/API/Model/Tests"

source ./config.sh

curl --remote-name https://apidocs.saritasa.io/Traffic-anti-jam/develop/Traffic-anti-jam-latest.yaml -k

java -cp "UnityCodegen-swagger-codegen-1.0.0.jar;swagger-codegen-cli.jar" io.swagger.codegen.v3.cli.SwaggerCodegen generate \
-l UnityCodegen \
-i Traffic-anti-jam-latest.yaml \
-c config.json \
-o ret
